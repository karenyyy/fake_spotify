...
<script>
    $(document).ready(function() {
        $.getJSON("http://ws.audioscrobbler.com/2.0/?method=geo.gettopartists&country=india&limit=100&api_key=e4352f4de078644ba4e562e03f3b23d3&format=json&callback=?", function(json) {
            var html = "<h1 style='text-align: center'>Top 100 Artists of 2018 (India)</h1><br><div id=\"mainContent\" style='margin-left: 250px'>";
